...
const float maxTessLevel = 16.0;  // Reduced from 64 to keep wireframe visible at close range
const float minDistance = 1.0;    // Distance for maximum tessellation (increased from 0.5)
