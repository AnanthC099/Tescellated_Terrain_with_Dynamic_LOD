...
VkResult UpdateUniformBuffer(void)
{
	...
	float camDistance = 6.0f; // Distance back from center

	myUniformData.viewMatrix = glm::lookAt(
		glm::vec3(0.0f, camHeight, camDistance),  // Camera position: elevated and back
		glm::vec3(0.0f, 0.0f, 0.0f),              // Look at center of terrain
