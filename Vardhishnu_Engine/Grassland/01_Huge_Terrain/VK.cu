...
VkResult UpdateUniformBuffer(void)
{
	...
	myUniformData.viewMatrix = glm::lookAt(
		glm::vec3(cameraX, camHeight, cameraZ),
		glm::vec3(cameraX, 0.0f, cameraZ - 6.0f),
		glm::vec3(0.0f, 1.0f, 0.0f)
	);

	glm::mat4 perspectiveProjectionMatrix = glm::mat4(1.0f);
	perspectiveProjectionMatrix = glm::perspective(glm::radians(45.0f), (float)winWidth/(float)winHeight, 0.1f, 2000.0f);
